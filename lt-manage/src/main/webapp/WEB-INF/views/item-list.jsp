...
<table class="easyui-datagrid" id="itemList" title="商品列表" 
    ...
    <thead>
        <tr>
            ...
            <th data-options="field:'cid',width:100,align:'center',formatter:KindEditorUtil.findItemCatName">叶子类目</th><!-- ,formatter:KindEditorUtil.findItemCatName（恢复）去掉展示叶子节点的数据 -->
